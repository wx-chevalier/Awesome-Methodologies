...
可以在 [Spring Initializr](https://start.spring.io/) 动态地选择需要的组件，对于 Spring 框架/生态的讨论，以及 IOC/DI 等机制原理的分析参考 [Spring CheatSheet](https://github.com/wxyyxc1992/Awesome-CheatSheets/blob/master/Backend/WebFramework/Java/Spring-CheatSheet.md)
